...
void build_scene(Scene& scene) {
	...
	Sphere* mirror_sphere = make_sphere(Vertex(0.f, 10.f, 10.f), 8.f, mirror);
    scene.add_object(mirror_sphere);

    Sphere* blue_sphere = make_sphere(Vertex(5.f, 10.f, -2.f), 2.f, blue);
    scene.add_object(blue_sphere);

    Sphere* red_sphere = make_sphere(Vertex(-9.f, 10.f, 0.f), 4.f, red_mirror);
...
int main(int argc, char *argv[]) {
	...
	fb->writeRGBFile((char *)"final_reflection.ppm");
